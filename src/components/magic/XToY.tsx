...
export function Marquee3D() {
    return (
        <div className="relative mx-auto mt-[10px] flex h-full w-full flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border bg-background px-20 md:shadow-xl">
